...
let TimeWaitFeedback = require('./TimeWaitFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class TimeWaitActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TimeWaitFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TimeWaitFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TimeWaitActionFeedback(null);
    ...
    data.feedback = TimeWaitFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TimeWaitActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TimeWaitFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TimeWaitFeedback()
    }
...
module.exports = TimeWaitActionFeedback;
