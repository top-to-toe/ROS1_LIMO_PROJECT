...
"""autogenerated by genpy from hello_ros/TimeWaitActionResult.msg. Do not edit."""
import codecs
import sys
...
class TimeWaitActionResult(genpy.Message):
  _md5sum = "7c9cdc0a5a70507b0146e3ed54c2d936"
  _type = "hello_ros/TimeWaitActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hello_ros/TimeWaitResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TimeWaitActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = hello_ros.msg.TimeWaitResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = hello_ros.msg.TimeWaitResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_fI().pack(_x.result.time_elapsed, _x.result.updates_sent))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.time_elapsed, _x.result.updates_sent,) = _get_struct_fI().unpack(str[start:end])
      return self
