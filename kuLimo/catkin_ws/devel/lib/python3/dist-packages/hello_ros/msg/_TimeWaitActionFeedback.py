...
"""autogenerated by genpy from hello_ros/TimeWaitActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TimeWaitActionFeedback(genpy.Message):
  _md5sum = "c67d87ce97931f62b7574eae4961f0d2"
  _type = "hello_ros/TimeWaitActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hello_ros/TimeWaitFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TimeWaitActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = hello_ros.msg.TimeWaitFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hello_ros.msg.TimeWaitFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2f().pack(_x.feedback.time_remaining, _x.feedback.time_elapsed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.time_remaining, _x.feedback.time_elapsed,) = _get_struct_2f().unpack(str[start:end])
      return self
